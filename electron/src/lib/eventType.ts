...
export const EVENT_TYPE = {
  ...
  ACTION: {
    ...
    FETCH_IMAGE: 'EVENT_TYPE.ACTION.FETCH_IMAGE',
    FETCH_IMAGE_RESPONSE: 'EVENT_TYPE.ACTION.FETCH_IMAGE_RESPONSE',
  ...
  NATIVE_THEME: {
    SHOULD_USE_DARK_COLORS: 'EVENT_TYPE.NATIVE_THEME.SHOULD_USE_DARK_COLORS',
    SUBSCRIBE: 'EVENT_TYPE.NATIVE_THEME.SUBSCRIBE',
    UPDATED: 'EVENT_TYPE.NATIVE_THEME.UPDATED',
  },
  CONTEXT_MENU: {
  ...
  UI: {
    ...
    SYSTEM_MENU_TO_WEBVIEW: 'EVENT_TYPE.UI.SYSTEM_MENU_TO_WEBVIEW',
