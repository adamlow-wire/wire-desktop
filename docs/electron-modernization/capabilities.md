...
| DCP-005 | Tray and native application menu | Windows, macOS, Linux | Sensitivity-proven tray click, tooltip, unread/flashing, icon selection, and macOS/non-macOS platform tests; menu E2E | low | TST-003 | CAP-004 | Hosted platform validation plus packaged native smoke |
