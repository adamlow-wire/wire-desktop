...
| DCP-011 | Proxy configuration and authentication | Windows, macOS, Linux | Proxy parsing/generation tests plus exact local URL/session view identity | low | BASE-002 | CAP-005 | Session-targeted auth, cancellation, credential handling, packaged enterprise smoke |
