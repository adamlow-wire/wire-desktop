...
| DCP-002 | Multi-account add/switch/remove | Windows, macOS, Linux | Critical/regression E2E; sensitivity-proven reducer lifecycle and queued-action flush contracts; account-only loaded notification with per-view quota; secure-shell exact-target, partition, IPC, and storage-isolation tests | medium | BASE-002, TST-004 | CAP-001 | Account-targeted product action routing, lifecycle E2E, and packaged three-account switch/remove smoke |
