...
| DCP-003 | Enterprise and automated SSO | Windows, macOS, Linux | Characterization includes a deterministic Electron fixture and exact SSO origin/session/account view identity; three CAP-002 security targets quarantined | medium | TST-002 | CAP-002 | Controlled IdP E2E, protocol abuse tests, cookie/account isolation, cleanup |
