...
| `wire-desktop:deep-link:submit:v1` | application shell | Protocol/action dispatch | current PR validation; parser and lifecycle policy remain open | SEC-003, SEC-013, CAP-006 |
