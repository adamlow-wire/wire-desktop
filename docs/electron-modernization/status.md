...
- **Media and consent sensitivity:** fake-device media tests pass 2/2; ignoring consent grants synthetic tracks and fails cancellation. Document revocation, stale answers, pending-request bounds, Cancel as default, and consent-abort propagation have sensitivity-proven targets. See `/tmp/sec009-media-sensitivity.log`, `/tmp/sec009-consent-navigation-sensitivity.log`, `/tmp/sec009-notification-preload-sensitivity.log`, `/tmp/sec009-consent-dialog-sensitivity.log`.
