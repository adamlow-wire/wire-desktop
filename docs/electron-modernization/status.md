...
| Upstream synchronization local validation | Integrated upstream `6f9b6a99`; ported secure-shell startup through upstream's split main-process entrypoint; application/test types passed, Jest 19/19 suites and 63/63 tests passed, renderer 2/2 and build tools 35/35 passed; isolated tray and secure-shell rerun passed 13/13 after the known full-suite timing flakes | 2026-09-02 |
