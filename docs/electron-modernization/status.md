...
2. **[PR #44](https://github.com/adamlow-wire/wire-desktop/pull/44), SEC-012**, is synchronized with merged #46. Previous head `8a7af56b` passed Windows E2E and all static/package gates but failed macOS fixture teardown. Current head `9bac19b2` passes local types, 530 main tests and sandboxed metadata/navigation checks. Hosted [build](https://github.com/adamlow-wire/wire-desktop/actions/runs/34333303038), [packages](https://github.com/adamlow-wire/wire-desktop/actions/runs/34333303096) and [E2E/report](https://github.com/adamlow-wire/wire-desktop/actions/runs/34333303173) are running. Do not substitute #46 results or rerun the old head. After all pass and comments are reviewed, self-merge #44, then synchronize and retarget #45.
