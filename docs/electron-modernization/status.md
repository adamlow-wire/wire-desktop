...
| TST-003 local tray characterization | Commit `ea559431`: focused tray tests 9/9 and full Electron main coverage 164 passing with 3 owned CAP-002 targets pending; types, lint, formatting, and changed-statement coverage (27/31, 87.10%) passed. Temporary macOS/non-macOS platform mutations failed the intended tests and were reverted; hosted package validation remains pending | 2026-09-02 |
