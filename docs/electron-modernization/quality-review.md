...
- Read AGENTS.md and its six documents in order; verify actual branches, PR60 merge, protections and CI. Publish/integrate this plan branch with applicable checks if still pending. Use existing work items and branches where appropriate.
