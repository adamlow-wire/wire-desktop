...
Current integration is2ee0be97 after reviewed PR #54; all final-head checks and46 authenticated E2E cases per platform pass. Final source audit reopened INV-010: action/settings/startup diagnostics expose synthetic credentials in regression tests. Complete this focused correction on existing cap/CAP-006-second-instance-2026-09-10 in /tmp/m3-cap005-packaged, qualify all final gates, then close M3. Revalidate this inventory before acting. No overlapping branches or subagents.
