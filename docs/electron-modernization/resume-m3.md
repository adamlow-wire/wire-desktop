...
- SSO and E2EI enrolment/renewal are mandatory CAP-002/M3 scope. Current E2EI fixtures prove transport boundaries only—not enrolment, ACME issuance, verified identity, restart or renewal. Determine the real implementation gap and dedicated staging OIDC/ACME prerequisites. Do not reuse production/shared test identities or expose secrets.
