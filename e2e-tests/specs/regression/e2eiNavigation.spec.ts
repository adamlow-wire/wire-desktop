...
test('[characterization][CAP-002][DCP-022] E2EI redirect boundary denies an unregistered provider', async ({}, testInfo) => {
  ...
  try {
    ...
    const query = 'code=fixture-code&state=fixture-state&session_state=fixture-session';
